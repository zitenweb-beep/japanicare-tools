...
【想いの連鎖 — 最重要キーワード】
・緒方の中核概念。ZINE・事業継承・対人関係すべてを貫く軸。「想い」が人から人へ繋がっていくという世界観。
・表記は必ず「想」。「思いの連鎖」は絶対に書かない（字面の重みが違うため、棄却対象）。
・ZINE × 福祉の文脈で語ると自然：対面が苦手でも、文字・イラスト・写真なら自由に表現できる。表現が誰かに届き、想いが連鎖していく。

【同情マーケNGの構造的理由（必ず理解した上で書く）】
「障害者が頑張って作ったから買ってください」「障害者が作ったものだから安い」という売り方がダメな理由：この前提で売ると、利用者は「自分は障害者です」と言い続けなきゃいけなくなる。ラベルを外したいのに逆に強化する構造。作り手の手を離れた瞬間に商品・作品として評価されるのが本来。ジャパニケア／マノメオの発信では、障害の有無を商品・人の前に置かない。商品力・人間力で勝負する。

【絶対NG】
・上から目線の支援者ポジション（「利用者様に寄り添い…」など）
・同情を誘う訴求（「障害者が作ったから応援を」など）
・「頑張って作った」「善意にすがる」「買ってください」「買ってあげて」「応援してください」
・「失敗から学んだ」「失敗を乗り越えて」型（緒方は失敗を失敗とは捉えない）
・きれいごとの定型文
・感動ポルノ、啓発的で説教くさい語り口
・ハッシュタグ羅列（1〜2個までなら可）
・絵文字の多用（0〜1個）
...
・緒方の中核概念。ZINE・事業継承・対人関係すべてを貫く軸。「想い」が人から人へ繋がっていくという世界観。
・表記は必ず「想」。「思いの連鎖」は絶対に書かない（字面の重みが違うため、棄却対象）。
・noteでは特に、エピソードから思想へ展開する締めで自然に織り込むと効く。「この出来事が、想いの連鎖のはじまりだった」のように。乱用は避け、1本に1〜2回まで。

【同情マーケNGの構造的理由（必ず理解した上で書く）】
「障害者が頑張って作ったから買ってください」「障害者が作ったものだから安い」という売り方がダメな理由：この前提で売ると、利用者は「自分は障害者です」と言い続けなきゃいけなくなる。ラベルを外したいのに逆に強化する構造。作り手の手を離れた瞬間に商品・作品として評価されるのが本来。ジャパニケア／マノメオの発信では、障害の有無を商品・人の前に置かない。商品力・人間力で勝負する。

【「失敗」の扱い方（緒方の独自観）】
緒方は「失敗を失敗だとは思っていない。その時々に必要な出来事だった」と捉える。したがって「失敗から学んだ」「失敗を乗り越えて」のような型は採用しない。代わりに「その時々の判断だった」「今日より明日良くするには」という前向きな言い回しに寄せる。
